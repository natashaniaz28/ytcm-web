    ...
    <div className="space-y-6 animate-fade-up">
      ...
      <Card>
        ...
        <div className="flex items-end gap-4 mb-4">
          ...
          <Btn onClick={runLangDist} disabled={langLoading || !session}>
            {langLoading ? <Loader2 size={14} className="animate-spin" /> : <Languages size={14} />}
            {langLoading ? 'Running…' : 'Plot Distribution'}
          </Btn>

          <Btn onClick={runLangConflicts} disabled={confLoading || !session} variant="ghost">
      ...
      <Card>
        ...
        <Btn onClick={runWordcloud} disabled={wcJob.isRunning || !session}>
          <Cloud size={14} />
      ...
      <Card>
        ...
        <Btn onClick={runTopics} disabled={topicsJob.isRunning || !session}>
          <TagIcon size={14} />
